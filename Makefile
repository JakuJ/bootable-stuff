...
image.bin: $(shell find kernel -type f) bootloader.o
	i386-elf-gcc -m32 kernel/src/*.cpp bootloader.o -o image.bin -nostdlib -ffreestanding -std=c++17 -mno-red-zone -fno-exceptions -nostdlib -fno-rtti -O2 -Wall -Wextra -T linking.ld
